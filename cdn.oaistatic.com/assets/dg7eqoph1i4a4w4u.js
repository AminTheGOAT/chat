...
function k({
    ...
    return e.jsx(x, {
        className: o,
        children: c.map((d, m) => e.jsx(y, {
            index: m + l,
            width: d,
            className: h(n > 0 && (m + 1) % n === 0 && "mb-snc-1"),
            customAnimation: a ? {
                initial: {
                    scaleX: a.initialScaleX
                },
                animate: {
                    scaleX: 1
                },
...
export {
    k as P, v as a, y as b
};
//# sourceMappingURL=dg7eqoph1i4a4w4u.js.map